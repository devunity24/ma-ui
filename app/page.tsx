  ...
  return (
    <div className="min-h-screen bg-orange-50">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative aspect-video rounded-xl overflow-hidden bg-orange-200 shadow-lg hover:shadow-xl transition-shadow duration-300"
            >
              <Image
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/20" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-slate-900">Everything You Need to Succeed</h2>
      ...
      <section className="py-16 bg-orange-50">
        <div className="container mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold text-center mb-16 text-slate-900">Explore Lessons</h2>
          ...
          >
            {["TOI", "NBT", "Education Times"].map((name, index) => (
              <motion.div
                ...
                className="h-16 w-32 bg-white rounded-lg shadow-md flex items-center justify-center transform hover:scale-105 transition-all duration-300"
              >
      ...
      <footer className="border-t py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-slate-600">
                Empowering students with practical knowledge in Science, Mathematics, and Technology.
              </p>
            </div>
            <div>
          ...
          <div className="mt-12 pt-8 border-t text-center text-sm text-slate-600">
            <p>&copy; {new Date().getFullYear()} Modern Academy. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
